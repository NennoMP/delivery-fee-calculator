...
class TestDelivery(unittest.TestCase):
    ...
    def test_cart_exceptions(self):
        ...
        # <cart_value> invalid (not an integer)
        payload = {
                'cart_value': "a",
    ...
    def test_distance_exceptions(self):
        ...
        # <delivery_distance> invalid (not an integer)
        payload = {
                'cart_value': "a",
                'delivery_distance': -5,
                'number_of_items': 4,
    ...
    def test_items_exceptions(self):
        ...
        # <number_of_items> invalid (not an integer)
        payload = {
                'cart_value': "a",
    ...
    def test_time_exceptions(self):
        ...
        # <time> is invalid (not a datetime)
        payload = {
                'cart_value': 500,
                'delivery_distance': 2000,
                'number_of_items': 4,
        ...
        # <time> is invalid (not ISO format)
        payload = {
                'cart_value': 500,
                'delivery_distance': 2000,
                'number_of_items': 4,
